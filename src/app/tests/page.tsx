...
const TESTS: TestCard[] = [
  ...
  {
    id: "chimp",
    title: "Chimp Test", // Или "Тест Шимпанзе"
    description:
  ...
  },
  {
    ...
    icon: Type,
    category: "PRECISION", // Или оставить PRECISION, это подходит
    plays: "720K",
    avgScore: "52 WPM",
  ...
  {
    id: "visual",
    title: "Visual Memory", // Или "Визуальная память"
    description:
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-10 justify-between items-start md:items-center">
        ...
        <div className="flex flex-wrap gap-2">
          {["ALL", "REACTION", "MEMORY", "PRECISION"].map((tab) => (
            <button
              key={tab}
